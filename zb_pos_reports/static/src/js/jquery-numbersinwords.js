(function ($) {
    ...
    { id: "USD", leftSingular: "dollar", leftPlural: "dollars", rightSingular: "cent", rightPlural: "cents" },{ id: "BD", leftSingular: "Bahraini Dinar", leftPlural: "Bahraini Dinar", rightSingular: "Fils", rightPlural: "Fils" }];
    ...
    $.fn.moneyinwords = function (valornumerico, langSigla = "PT", coin = "") {
        ...
        if (centavos) {
            ...
            if (e == 0) {
                resultadoExtenso = textCentimos  + dezenasUnidadesValor(unidezcemCentavos) ;
            } else {
                centavosExtenso = separadorDecimal+ textCentimos +' '+  dezenasUnidadesValor(unidezcemCentavos);
            }


        }
        console.log(centavosExtenso)
        //acrescentar moeda + centavos na variavel
        resultadoExtenso += centavosExtenso;


        result =  nomeMoeda  +' '+  resultadoExtenso
        // console.log(textCentimos,'textCentimos',nomeMoeda,centavosExtenso,resultadoExtenso)
        return result;
